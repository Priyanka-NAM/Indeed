    ...
    <Container className={classes.container} maxWidth='xl'>
      ...
      <Box className={classes.boxForm}>
        ...
        <Typography align='left' variant='caption'>
          By creating an account, you agree to Indeed's{" "}
          <Link
            to='/'
            style={{ textDecoration: "none", color: "#085ff8" }}
            href=''>
            Terms of Service
          </Link>
          ,{" "}
          ...
          <br />
          and{" "}
          <Link to='/' style={{ textDecoration: "none", color: "#085ff8" }}>
            Privacy Policy.
          </Link>
          . You consent to receiving marketing messages from Indeed <br />
          and may opt out from receiving such messages by following the
